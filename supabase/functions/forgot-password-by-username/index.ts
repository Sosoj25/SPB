...
//
// คู่กับ login-with-username และต้องอยู่ฝั่ง server ด้วยเหตุผลเดียวกัน: การ
// แปลงชื่อผู้ใช้เป็นอีเมลจากเบราว์เซอร์เท่ากับเปิดให้ใครก็ได้ถามอีเมลของบัญชี
// คนอื่น ต่อให้หน้าจอจะตอบข้อความเดียวกันเสมอไม่ว่าจะเจอบัญชีหรือไม่ก็ตาม
//
