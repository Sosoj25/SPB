// ตั้งค่าการรับเงินที่แอดมินแก้เองได้จาก /admin/payments/settings
// — บัญชีปลายทางสำหรับโอน และสวิตช์เปิด/ปิดแต่ละช่องทาง
import { supabase } from "./supabase";

// ---------- บัญชีรับเงิน (โอนผ่านบัญชี + แนบสลิป) ----------
//
// หน้าชำระเงินอ่าน "บัญชีหลัก" (is_primary) มาแสดงเสมอ ห้ามฮาร์ดโค้ดเลขบัญชี
// ไว้ในหน้าใดหน้าหนึ่ง เพราะแอดมินเปลี่ยนบัญชีได้ตลอดเวลา
