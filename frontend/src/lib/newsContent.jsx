...
//
// เดิม toolbar แทรก syntax นี้ให้ แต่ฝั่งแสดงผล (News.jsx / NewsDetail.jsx)
// เอาข้อความไปโชว์ตรง ๆ ไม่มีอะไรแปลง syntax กลับเป็นรูปแบบจริง ปุ่มเลย
// "ใช้ไม่ได้จริง" — ไฟล์นี้แปลง syntax เดียวกันกลับเป็น React element ตอน
// แสดงผล ไม่ใช้ dangerouslySetInnerHTML เพื่อไม่เปิดช่องให้ข้อความอื่นที่พิมพ์
// เข้ามาบังเอิญมีรูปแบบคล้าย HTML ถูกตีความเป็น markup จริง — ข้อความที่ไม่ตรง
// กับ syntax ที่รู้จักจะโดน React escape เป็นตัวอักษรธรรมดาเสมอ
