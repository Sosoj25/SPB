...
// ระบบคืนเงิน (0034) — ลูกค้ายกเลิกการจองที่จ่ายเงินแล้วขอคืนเงินได้จริง
// แอดมินอนุมัติ/ปฏิเสธ แล้วแนบสลิปโอนคืนเพื่อปิดงาน ดูคอมเมนต์หัวไฟล์ migration
// สำหรับเหตุผลที่ไม่แตะ enum payment_status เดิม
